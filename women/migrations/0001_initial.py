    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=255, unique=True, validators=[django.core.validators.MinLengthValidator(5, message='мало символов!!! минимум 5!'), django.core.validators.MaxLengthValidator(100, message='че так много!? максимум 100')], verbose_name='Slug')),
